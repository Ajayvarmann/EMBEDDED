...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
    ...
    USART3->CR1 |= USART_CR1_UE; // Enable USART3
		   GPIO_InitTypeDef initc = {GPIO_PIN_8 | GPIO_PIN_9|GPIO_PIN_6|GPIO_PIN_7, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_FREQ_LOW,GPIO_NOPULL};
...
if (ch == 'R') {
    if (action == '0') {
        GPIOC->BSRR |= GPIO_PIN_6 << 16; // Turn off RED LED
    } else if (action == '1') {
        GPIOC->BSRR |= GPIO_PIN_6; // Turn on RED LED
    } else if (action == '2') {
    ...
    if (action == '0') {
        GPIOC->BSRR |= GPIO_PIN_7 << 16; // Turn off BLUE LED
    } else if (action == '1') {
        GPIOC->BSRR |= GPIO_PIN_7; // Turn on BLUE LED
    } else if (action == '2') {
    ...
    if (action == '0') {
        GPIOC->BSRR |= GPIO_PIN_8 << 16; // Turn off ORANGE LED
    } else if (action == '1') {
        GPIOC->BSRR |= GPIO_PIN_8; // Turn on ORANGE LED
    } else if (action == '2') {
    ...
    if (action == '0') {
        GPIOC->BSRR |= GPIO_PIN_9 << 16; // Turn off GREEN LED
    } else if (action == '1') {
        GPIOC->BSRR |= GPIO_PIN_9; // Turn on GREEN LED
    } else if (action == '2') {
